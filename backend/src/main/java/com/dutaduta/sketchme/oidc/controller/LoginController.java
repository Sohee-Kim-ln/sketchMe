...
public class LoginController {
    ...
    public void kakaoCallback(@RequestParam String code, RedirectAttributes redirectAttributes, HttpServletResponse response) throws IOException {
        ...
        String rediret_uri = "https://sketchme.ddns.net/dev/login/kakao/?access_token="+tokenResponseDto.getAccess_token()+"&refresh_token="+tokenResponseDto.getRefresh_token();
